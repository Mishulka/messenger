...
<div class="${styles.profile_container}">
    ...
    {{> SettingField label-name="Старый пароль" placeholder="_" name="old_password" type="password"}}
    {{> SettingField label-name="Новый пароль" placeholder="_" name="new_password" type="password"}}
    {{> SettingField label-name="Повторите новый пароль" placeholder="_" name="new_password" type="password"}}
<div class="${styles.profile_container}">
